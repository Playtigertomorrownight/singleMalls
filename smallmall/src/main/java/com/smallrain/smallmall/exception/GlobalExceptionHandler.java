...
public class GlobalExceptionHandler extends ResponseEntityExceptionHandler {
   ...
   * @return 响应结果
   */
  @ExceptionHandler(SmallrMallException.class)
  public Response SmallrMallExceptionHandler(HttpServletRequest request, final Exception e, HttpServletResponse response) {
      response.setStatus(HttpStatus.BAD_REQUEST.value());
      SmallrMallException exception = (SmallrMallException) e;
