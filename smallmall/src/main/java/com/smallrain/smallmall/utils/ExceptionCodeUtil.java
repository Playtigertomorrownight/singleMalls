package com.smallrain.smallmall.utils;
...
public class ExceptionCodeUtil {
  ...
  //错误码定义
  public static final int EXCEPTION_CODE_PARAM_ERROR = 601;    //参数为空错误
  public static final int EXCEPTION_CODE_DATABASE_ERROR = 602; //数据库错误
